...
| Preset | Description
| :--- | :--- 
| **blocked_only** | Proxy only known blocked domains and CIDRs (⚠️ requires [runetfreedom](https://github.com/runetfreedom/russia-v2ray-rules-dat) geofiles)
...
2. Click **Add** and fill the boxes: **Remark** - any name, **Domain Strategy** - choose **IPIfNonMatch**, **URL** - paste the raw link of the chosen preset.
